module.exports = (app, con) => {
    ...
    app.put('/news/:newsId', function (request, responce) {
        ...
        sqlquery = "Update news set `title` = '" + request.body.title + "', `article` = '" + request.body.article + "' where id = " + request.params.newsId + ";";
        con.query(sqlquery, function(err, resp) {
            if (err) throw err;
    ...
    app.put('/fans/:appealId', function (request, responce) {
        ...
        sqlquery = "Update fans set `appeal` = '" + request.body.appeal + "', `ap_date` = '" + getDate() + "' where id = " + request.params.appealId + ";";
        con.query(sqlquery, function(err, resp) {
            if (err) throw err;
    ...
    app.post('/fans.html', function (req, res) {
        ...
        res.sendFile(__dirname + '/site/fans.html');
    });
