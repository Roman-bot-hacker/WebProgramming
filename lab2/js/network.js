...
var title = document.querySelector('input[name="news_title"]');
//article text
var article = document.querySelector('textarea[name="news_text"]');
...
(function () {
    if (window.applicationCache) {
        ...
        /*document.getElementById('submit_news').addEventListener('click', send, true);*/
        reportNetworkStatus();
